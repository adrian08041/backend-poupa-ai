...
@Catch(WhatsappNotLinkedUsecaseException)
export class WhatsappNotLinkedUsecaseExceptionFilter
  implements ExceptionFilter
{
  public catch(
    exception: WhatsappNotLinkedUsecaseException,
    host: ArgumentsHost,
  ) {
...
export const WhatsappNotLinkedUsecaseExceptionFilterProvider = {
  provide: APP_FILTER,
  useClass: WhatsappNotLinkedUsecaseExceptionFilter,
};
